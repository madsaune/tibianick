...
var (
	...
	titles       = []string{"Lord", "Dark", "Mistress", "King", "Queen", "Lady", "Mister"}
...
func main() {
	...
	fmt.Println(createRandomName(nameLength, includeWorld, includeTitle))
}
...
func createRandomName(length int, ofWorld, title bool) string {
